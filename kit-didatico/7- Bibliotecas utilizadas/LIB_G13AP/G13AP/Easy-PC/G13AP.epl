...
(library Library_1
	...
	(patternDef "G13AP" (originalName "G13AP")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.270, -2.540) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.98 0.96) (pt 3.52 0.96) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.52 0.96) (pt 3.52 -6.04) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.52 -6.04) (pt -0.98 -6.04) (width 0.2))
		)
		(layerContents (layerNumRef 28)
			(line (pt -0.98 -6.04) (pt -0.98 0.96) (width 0.2))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "G13AP" (originalName "G13AP") (compHeader (numPins 5) (numParts 1) (refDesPrefix S)
		...
		(attr "Datasheet Link" "https://www.nkkswitches.com/pdf/Gtoggles.pdf")
		(attr "Height" "10.8 mm")
	)
